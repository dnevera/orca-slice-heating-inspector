...
def generate_html(f1_data, f2_data=None):
    ...
    return HTML_TEMPLATE.replace("%DATA_JSON%", json.dumps(js_data))
...
# HTML template for the Canvas-based temperature timeline renderer.
# Contains ~880 lines of JS for zoom/pan/hover temperature visualization.
HTML_TEMPLATE = r"""<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title>Slice Heating Inspector</title>
    <style>
        body {
            margin: 0; padding: 0;
...
<body>
    <div id="header">
        <div id="title">Temperature Timeline</div>
...
if (data.is_comparison) {
    titleEl.innerText = "Comparison:\n1. " + data.file1.filename + "\n2. " + data.file2.filename;
} else {
    titleEl.innerText = "Temperatures:\n" + data.file1.filename;
}
